...
export default async function AppLayout({ children }: PropsWithChildren) {
  ...
  await Promise.all([
    tsrQueryClient.protected.users.getSelf.prefetchQuery({ queryKey: ["selfUserProfile"] }),
    tsrQueryClient.protected.budgeting.workspaces.getWorkspaces.prefetchQuery({ queryKey: ["workspaces"] }),
  ]);
