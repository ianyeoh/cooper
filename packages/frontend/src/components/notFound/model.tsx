...
import { AsciiRenderer, Center, Text3D, useGLTF } from "@react-three/drei";
...
export function Model(props: JSX.IntrinsicElements["group"]) {
  ...
  const { nodes, materials } = useGLTF("/models/low_poly_computer_desk.glb") as GLTFResult;
  return (
    <group {...props} dispose={null}>
      ...
      />
      <group>
        <mesh position={new THREE.Vector3(-4, 100.815, 39.4)} scale={5}>
          <Center>
            <Text3D font="/fonts/Roboto.json">
              404
              <meshStandardMaterial color="rgb(50, 230, 89)" />
            </Text3D>
          </Center>
        </mesh>
        <mesh position={new THREE.Vector3(-4, 95, 40.5)} scale={1.7}>
          <Center>
            <Text3D font="/fonts/Roboto.json">
              Page not found
              <meshStandardMaterial color="rgb(50, 230, 89)" />
